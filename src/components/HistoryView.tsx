...
import { Clock, Shield, Trash2, ChevronRight, Search } from 'lucide-react';
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative w-12 h-12 shrink-0">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center text-xs font-bold" style={{ color: getScoreColor(scan.score) }}>
                      {scan.score}
                    </span>
                  </div>
